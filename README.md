...
- [赛事验证清单](docs/EVENT_VALIDATION_WATCHLIST.md)与[Baku 2026 F1 审计](docs/BAKU_2026_F1_DATA_FEASIBILITY.md)：按日期选择案例、区分计划公告与独立观测。[城市数据重建](data/README.md)记录 Berlin/Baku 的固定 OSM 与本体化 KG。
